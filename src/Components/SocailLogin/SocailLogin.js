    ...
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={() => signInWithGoogle()} className='form-btn-text my-2 ' type="submit">
                    <div className='img-google'>
                        <span><small><img src={google} alt="" /></small> Sign Up with Google</span>
                    </div>
                </button>
                <button onClick={() => signInWithFacebook()} className='form-btn-text my-2 bg-primary text-white' type="submit">
                    <div className='img-google'>
                        <span><small><img style={{ width: "30px" }} src={facebook} alt="" /></small> Sign Up with FaceBook</span>
                    </div>
                </button>
                <button onClick={() => signInWithGithub()} className='form-btn-text my-2 github-btn' type="submit">
                    <div className='img-google'>
